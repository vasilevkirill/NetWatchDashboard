<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href="/">
                <img src="/static/img/66016cf86cb97.png"  alt="NetWatchDashboard" class="navbar-brand-image">
            </a>
        </h1>
                ...
                <li class="nav-item">
                  ...
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="5 12 3 12 12 3 21 12 19 12" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
                        ...
                        <span class="nav-link-title">Домой</span>
                    </a>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="/ui/settings/users">Пользователи</a>
                        <a class="dropdown-item" href="/ui/settings/common">Общие</a>
                        <a class="dropdown-item" href="/ui/settings/devices">Устройства</a>
                    </div>
                </li>
